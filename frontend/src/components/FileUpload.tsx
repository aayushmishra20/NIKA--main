...
const useFileUpload = () => {
  ...
  const handleFile = useCallback(async (file: File | null) => {
    ...
    try {
        ...
        try {
          ...
          if (insightsData.data && Array.isArray(insightsData.data)) {
            ...
            setState(s => ({
              ...
              datasetPreview: insightsData.data, // Use full dataset instead of limited preview
            }));
          } else {
      ...
      // --- Backend Upload (when Firebase is not available) ---
      ...
      setState(s => ({
        ...s,
        uploadStatus: 'success',
        datasetPreview: uploadedDataset.data, // Show all rows by default
      }));
